  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        _buildAction(context, Icons.share_outlined, "Paylaş"),
        _buildAction(context, Icons.download_outlined, "İndir"),
        _buildAction(context, Icons.library_add_outlined, "Kaydet"),
      ],
    );
  }
